...
export function createSection4(data: DescriptionDTO): Content {
     ...
     data.section4bcheckboxH
          ? formLabels4b.push('h) Nieprawidłowa anonimizacja danych osobowych w dokumencie')
          : null;
     ...
     data.breachOfDataConfidentiality
          ? content.push(
                 listDescription('Nieuprawnione lub przypadkowe ujawnienie bądź udostępnienie danych')
            )
          : null;
