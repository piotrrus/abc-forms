...
import { ViolationReasonForm } from 'src/shared/forms/violation-reasons.form';
...
export class ViolationReasonsFormComponent extends BaseFormComponent implements OnInit {
